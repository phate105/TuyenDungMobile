...
const ICONS = {
  candidate: require("../../../assets/icons/ungVien.png"),
  employer: require("../../../assets/icons/nhaTuyenDung.png"),
  ...
  application: require("../../../assets/icons/donUngTuyen.png"),
};
  ...
  const cards = useMemo(
    () => [
      ...
      },
      {
        ...
        icon: ICONS.pending,
        onPress: () => navigation.navigate("AdminJobsTab", { status: "pending" }),
      },
      {
        title: "Tin đã duyệt",
        value: stats.approvedJobCount,
        icon: ICONS.approved,
        onPress: () => navigation.navigate("AdminJobsTab", { status: "approved" }),
      },
      {
        title: "Tin bị từ chối",
        value: stats.rejectedJobCount,
        icon: ICONS.rejected,
        onPress: () => navigation.navigate("AdminJobsTab", { status: "rejected" }),
      },
      {
        title: "Đơn ứng tuyển",
